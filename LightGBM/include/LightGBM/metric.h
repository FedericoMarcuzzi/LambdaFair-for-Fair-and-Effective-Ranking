...
class RNDCalculator {
   public:
    ...
    static void sort_by(std::vector<int> &group, const double* score);

    static double rD(const std::vector<data_size_t> &group, size_t K, int truncation_level=0);

    static double max_rD(const std::vector<data_size_t> &group, size_t K, int truncation_level=0);

    static double rND(std::vector<data_size_t> group, const double* score, size_t K, double Z=-1, int truncation_level=0);
};
